...
function eventHandler() {
	...
	var SnowBgConts = document.querySelectorAll('.bg-snow-js');

	var _iterator = _createForOfIteratorHelper(SnowBgConts),
			_step;
	...
	var exampleSlider = new Swiper($(this).find(".example-slider-js"), {
		slidesPerView: 1,
		loop: true,
		breakpoints: {
			768: {
	...
	$('.sBlogBouquet__slider--js').each(function () {
		var BlogBouquetSlider = new Swiper($(this).find(".blog-buq-slider-js"), {
			slidesPerView: 1,
			loop: true,
			spaceBetween: 30,
			//lazy load
